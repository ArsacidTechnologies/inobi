...
get_box_update_version = FT.partial(get_box_setting, key='version', mapper=int)
...
get_box_internet = FT.partial(get_box_setting, key='allow_internet')
set_box_internet = FT.partial(set_box_setting, key='allow_internet')
